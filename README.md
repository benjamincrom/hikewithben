...
#### List all hikes API: 
#### https://hikewithben.appspot.com/_ah/api/hikewithben/v1/hike_list
#### Lookup individual hike API: 
#### https://hikewithben.appspot.com/_ah/api/hikewithben/v1/hike_display/{hike_id}
