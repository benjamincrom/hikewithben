...
class HikeMessage(messages.Message):
    ...
    hike_distance_miles = messages.FloatField(8)
    hike_location_longitude = messages.FloatField(9)
    hike_location_latitude = messages.FloatField(10)
    hike_elevation_gain = messages.IntegerField(11)
    hike_total_capacity = messages.IntegerField(12)
